...
async def process_all_cars_from_channel():
    ...
    for idx, ann in enumerate(announcements, 1):
        ...
        # Попытка извлечь основные данные для заголовка
...
Вот данные для заголовка, используй их:
- Модель: {title_model}
- Год: {title_year}
...
3. Основные характеристики (год выпуска, двигатель, мощность, пробег, кузов, привод, VIN)
...
Правила:
- Если данных для какого-то пункта нет, найди их в интернете. Если найти нельзя — пропусти пункт.
