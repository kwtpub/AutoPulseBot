...
ВАЖНО: Обязательно начни ответ с четкого формата:
[Марка] [Модель] [Год] - Цена: [цена с наценкой {markup_percentage}%]

Требования к результату:
1. ПЕРВАЯ СТРОКА должна быть в формате: [Марка] [Модель] [Год] - Цена: [цена]
2. Добавь наценку {markup_percentage}% к цене (если цена указана)
3. Создай КРАТКОЕ структурированное описание автомобиля (максимум 800 символов)
...
КРИТИЧНО: Обязательно начни с [Марка] [Модель] [Год] в квадратных скобках!
        """
        return prompt.strip()
